...
<html lang="en">
  <head>
    ...
    <title>Dajnad T-Shirt | About </title>
...
<div class="main">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="panel panel-primary">
                         <div class="panel-heading">
                             <h4 class="panel-title"> Abo Turi bo</h4>
                         </div>
                         <div class="panel-body">
                             <p>
                               <span class="text-primary"> <a href="index.php"> Grandpace </a> </span> est une societé Burundaise située à Kayanza qui a pour mission de promouvoir
                               la technologie artistique dans le pays.
                               Nous sommes ici pour vous aider dans different services.
                             </p>
                            <h4 class="text-primary">Vision :</h4>
                            <p>Innovation dans la qualité des services à nos clients.</p>
            ...
            <img src="images/products/colors_BW.jpg" alt="">
            <br>
            <hr>
            <div class="col-md-12">
